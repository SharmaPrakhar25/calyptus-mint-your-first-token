...
var keypair = umi.eddsa.createKeypairFromSecretKey(helper_js_1.userKeypair.secretKey);
umi.use((0, umi_1.keypairIdentity)(keypair)).use((0, mpl_token_metadata_1.mplTokenMetadata)());
var metadata = {
    name: "Solana Gold",
    symbol: "GOLDSOL",
...
function createMetadataDetails() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, mpl_token_metadata_1.createV1)(umi, {
                        mint: mint,
...
function mintToken() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, mpl_token_metadata_1.mintV1)(umi, {
                        mint: mint.publicKey,
                        authority: umi.identity,
                        amount: 10000,
